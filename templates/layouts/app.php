...
<div class="flex h-full">
    ...
    <aside class="w-64 bg-gray-900 border-r border-gray-800 flex flex-col flex-shrink-0">
        ...
        <nav class="flex-1 p-3 space-y-1">
            ...
            <a href="/my-calendar" class="sidebar-link flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium <?= $isActive('/my-calendar') ?>">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"/></svg>
                My Calendar
            </a>
            <?php if (Auth::isAdmin()): ?>
            <a href="/dispatch" class="sidebar-link flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium <?= $isActive('/dispatch') ?>">
